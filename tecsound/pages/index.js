...
export default function Home() {
  ...
  <div className="container mx-auto flex flex-col items-center">
    <form ref={refForm} class="shadow-lg w-80 p-4 flex flex-col bg-white rounded-lg">
      ...
      <input ref={refEmail} type="text" placeholder="Email" class="mb-3 py-3 px-4 border border-gray-400 focus:outline-none rounded-md focus:ring-1 ring-cyan-500" required/>
